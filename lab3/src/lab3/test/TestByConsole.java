...
public class TestByConsole implements Serializable {
    ...
    static private void Name() {      //Протоклювання імені користувача в log.txt
    ...
    static private void logging(String s) {    //Протоклювання дій користувача в log.txt  (Нужно добавить в каждый метод типа  addWood, addTibmer в TestByConsole
        try {
